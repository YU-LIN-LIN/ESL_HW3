...
define_hls_config GaussianFilter DPAUA       --dpopt_auto=op,expr  -DUNROLL_ALL
# Add configurations for various intitation intervals
define_hls_config GaussianFilter PIPELINE -DI=3

set IMAGE_DIR           ".."
set IN_FILE_NAME        "${IMAGE_DIR}/lena_std_short.bmp"
set OUT_FILE_NAME				"out_gaussian.bmp"
...
### DPopt + Unroll
define_sim_config V_DPAUA "GaussianFilter RTL_V DPAUA" -argv "$IN_FILE_NAME $OUT_FILE_NAME"
### PIPELINE
